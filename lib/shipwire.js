...
(function() {
     ...
     */
    this.orders = function(url, cols, callback) {
     ...
     */
    this.stock = function(url, cols, callback) {
     ...
     */
    this.rate = function(url, cols, callback) {
     ...
     */
    this.receivings = function(url, cols, callback) {
     ...
     */
    this.returns = function(url, cols, callback) {
     ...
     */
    this.products = function(url, cols, callback) {
